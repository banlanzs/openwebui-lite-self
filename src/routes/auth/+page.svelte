    ...
    async function setLogoImage() {
		...
		if (logo) {
            ...
            if (isDarkMode) {
				...
				darkImage.onload = () => {
                    if (logo) logo.src = `${WEBUI_BASE_URL}/static/favicon-dark.png`;
									...
									<div class="flex flex-col mt-4">
										...
										<div>
                                            ...
                                            <SensitiveInput
                                                ...
                                                type="password"
                                                id="password"
                                                outerClassName="my-0.5 w-full text-sm outline-hidden bg-transparent placeholder:text-gray-300 dark:placeholder:text-gray-600"
										...
										{#if mode === 'signup' && $config?.features?.enable_signup_password_confirmation}
											<div class="mt-2">
                                                ...
                                                <SensitiveInput
                                                    ...
                                                    type="password"
                                                    id="confirm-password"
                                                    outerClassName="my-0.5 w-full text-sm outline-hidden bg-transparent"
