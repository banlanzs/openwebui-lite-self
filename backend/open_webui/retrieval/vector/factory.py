...
class NullVectorClient(VectorDBBase):
    """No-op vector client used when vector DB support is disabled."""
    ...
    def insert(self, collection_name: str, items):
        raise RuntimeError("Vector database support is disabled")

    def upsert(self, collection_name: str, items):
        raise RuntimeError("Vector database support is disabled")
