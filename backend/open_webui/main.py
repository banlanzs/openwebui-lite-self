...
# Lite defaults
app.state.config.ENABLE_WEB_SEARCH = False
app.state.config.BYPASS_WEB_SEARCH_EMBEDDING_AND_RETRIEVAL = True
app.state.config.BYPASS_WEB_SEARCH_WEB_LOADER = True
app.state.config.BYPASS_EMBEDDING_AND_RETRIEVAL = True
...
# RAG/embedding pipeline disabled in this pared-down build
app.state.ef = None
app.state.rf = None
app.state.EMBEDDING_FUNCTION = None
app.state.RERANKING_FUNCTION = None
