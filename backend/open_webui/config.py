...
VECTOR_DB = os.environ.get("VECTOR_DB", "disabled")
...
if VECTOR_DB == "chroma":
    try:
        ...
        log.warning("chromadb not installed; disabling vector DB support")
        VECTOR_DB = "disabled"
...
RAG_OLLAMA_BASE_URL = PersistentConfig(
    "RAG_OLLAMA_BASE_URL",
    "rag.ollama_api_base_url",
    os.getenv("RAG_OLLAMA_BASE_URL", ""),
)
